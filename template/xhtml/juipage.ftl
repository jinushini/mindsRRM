...
<div class="panelBar">
	...
	<div class="pagination" targetType="navTab" totalCount="${parameters.count}" numPerPage="${parameters.pageSize}" pageNumShown="0" currentPage="${parameters.pageNo}"></div>

</div>
<script type="text/javascript">
	$(function(){
		$(".pages select",navTab.getCurrentPanel()).val('${parameters.pageSize}');
	})
</script>
