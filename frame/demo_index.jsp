...
<!--[if lt IE 9]><script src="../../frame/js/speedup.js" type="text/javascript"></script><script src="js/jquery-1.11.3.min.js" type="text/javascript"></script><![endif]-->
<!--[if gte IE 9]><!--><script src="../../frame/js/jquery-2.1.4.min.js" type="text/javascript"></script><!--<![endif]-->

<script type="text/javascript" src="../../frame/js/jquery-1.11.3.min.js"></script>
...
<script src="../../frame/bin/dwz.min.js" type="text/javascript"></script>
		...
		<div id="header">
			<div class="headerNav">
				...
				<ul class="nav">
					...
					<li><a href="donation.html" target="dialog" height="380">捐赠</a></li>
...
<a class="button" href="donation.html" target="dialog" height="380"><span style="color: red">捐赠我们</span></a>
