...
<div class="pageContent">
  <form action="../fextends/test!approve.action" id="searchFrm" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" >
