	...
	<form onsubmit="return navTabSearch(this);" action="<s:property value="page.url"/>" method="post">
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						阶段名称：<input type="text" name="paramMap['rfd.name like']" value="<s:property value="paramMap['rfd.name like']"/>" />
					</td>
				</tr>
			</table>
			<div class="subBar">
...
<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../fextends/HtyFlow_inputAdd_custom-flow-stage-add.action?parentId=<s:property value='parentId'/>" target="dialog" rel="" width='750' height='350'><span>新增</span></a></li>
			<li><a class="edit" href="../fextends/HtyFlow_inputEdit_custom-flow-stage-edit.action?id={id}&&parentId=<s:property value='parentId'/>" target="dialog" title="修改" width='750' height='350'><span>修改</span></a></li>	
			<li><a class="delete" href="../fextends/HtyFlow_delete.action?id={id}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>	
			<%-- <li><a class="icon" href="..//fextends/FTemplate_inputFTemplateDataConfig_ftemplate-data-config.action?id={id}" target="dialog" width="1050" height="480" mask="true"><span>配置子流程</span></a></li> --%>
			<li><a class="icon" href="../fextends/HtyFlow_goBack_custom-flow-link-list.action?parentId=<s:property value='parentId'/>" target="navTab" rel="currentNavTab" title="返回上一级"><span>返回</span></a></li>	
		</ul>
	</div>
	<div layoutH="10">
