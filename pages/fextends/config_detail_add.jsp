...
<div class="pageContent">
	<form method="post" id="searchFrm"
		action="../fextends/systemConfigDetail!add.action"
		...
		<div class="pageFormContent" layoutH="58">
			...
			<input name="systemConfig.systemConfig.id" type="hidden"
			...
			<table class="list_table edit_table" width="98%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input name="systemConfig.hiddenValue" type="hidden" class="required">
