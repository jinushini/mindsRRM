...
<div class="pageContent">
  <form action="../fextends/FlowRun_relevanceFlowRunConfig.action" id="searchFrm" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);" >
			...
			<table class="list_table edit_table" width="98%" style="table-layout:fixed;" >
				...
				<tbody id="itemList">
					<s:iterator value="list" status="st" var="a">
						<tr class="modifyTr">
							<td align="center" style="display: none;"><input type="text" class="modify" name="oldDataList[#index].subFlowId" value="<s:property value="id"/>"></td>
							<td align="center"><s:property value="flowName"/></td>
							<td align="center">
								<select name="oldDataList[#index].preFlowId">
