			...
			<tbody>
	  			...
	  			<s:iterator value="#attr.a.nodes" var="b">		
					<tr target="id" rel="<s:property value="id"/>" class="tr">
						...
						<td align="center">
							<a href="../fextends/FlowTemplate_inputFlowTemplateNodeConfig_flow-template-node-config-template.action?flowTemplatelNodeId=<s:property value="#attr.b.id"/>&&flowTemplateId=<s:property value="flowTemplateId"/>" target="dialog" width="1050" height="480" mask="true" title="编辑子模板">编辑</a>														
