...
<div class="pageContent">
	<form method="post" id="searchFrm" action="../fextends/conditionDict!add.action" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="58">
			...
			<table class="list_table edit_table" width="98%">
				<tbody>
					<tr>
						<th width='15%'>条件</th>
						<td><input name="procedureConditionDict.condition" type="text" class="required"></td>
					</tr>
				</tbody>
			</table>
		</div>
