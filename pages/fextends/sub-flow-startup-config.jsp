...
<div class="pageContent">
  <form method="post" action='../fextends/FlowRunData_startupSubFlow.action' class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	...
	<div class="pageFormContent" layoutH="56">
		<br/>
	<fieldset>
		<legend><s:property value="flowRunData.flowName"/>--参数配置</legend>
		<table bssaps="0" width="98%" class="edit_table" align="center">
			<tr>
				<td align="center">任务名称</td>
				<td><input name="wasteVo.flowName" type="text" value="<s:property value="flowRunData.flowName"/>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input class="dates" name="wasteVo.scheduleDate.manHours" value="<s:property value="flowRunData.scheduleDate.manHours"/>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="nodeCoinSet">
					<s:iterator value="flowRunData.coinSet" >
