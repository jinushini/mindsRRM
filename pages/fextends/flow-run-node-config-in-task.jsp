					...
					for(var i=0;i<data.flowModel.flowModelNodes.length;i++){
						...
						coinSet = coinSet + "<div style='width:100%;'>"
											...
											+ "<input type='hidden' name='newDataList[#index].coinList[#seq].parentNodeName' value='" + flowModelNode.nodesName + "' />"
						  					...
						  					+ "<input type='text' name='newDataList[#index].coinList[#seq].quantity' value='" + nodeCoin + "' style='text-align:left;float:left;height:14px;width:20%;border:1px solid #ccc;'/><br/>"
							              + "</div>";
					}
					var $coinSet = $(coinSet);
					$coinSet.initUI();
					...
					<tbody class="tbody">
						...
						<s:iterator value="list" status="st" var="a">
							<tr class="modifyTr">
								...
								<s:if test="status==5">
									<td align="center"><input type="text" name="oldDataList[#index].flowName" value="<s:property value='flowName'/>" style="width:99%;border:0;font-size:15px;text-align:center;"></td>
									...
									<td class="coinSet" style="padding:5px 3px;">
										<s:iterator value="coinSet" >
											<div style="font-size:15px;width:100%">
												...
												<input type="text" name="oldDataList[#index].coinList[#seq].quantity" value="<s:property value='quantity'/>" style="text-align:left;float:left;height:14px;width:20%;border:1px solid #ccc;"/>	<br/>
											</div>
										</s:iterator>
									</td>
								</s:if>
