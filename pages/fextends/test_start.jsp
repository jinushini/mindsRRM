...
<div class="pageContent">
  <form action="../fextends/test!startSProcess.action" id="searchFrm" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" >
