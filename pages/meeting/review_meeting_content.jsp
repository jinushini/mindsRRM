...
<div class="pageContent">
 	<form method="post" enctype="multipart/form-data" id="form" action="../meeting/reviewMeeting!handleReviewMeetingProcess.action" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);"> 
		...
		<fieldset>		
			...
			<table class="list_table edit_table" width="98%" id="itemList">
				...
				<tr>
						<th width='15%'>会议主题</th>
						<td colspan="3"><input name="meeting.subject" type="text" class="required" readonly="readonly" value="<s:property value="meeting.subject"/>">
						</td>
					</tr>			
					<tr>					
						<th width='15%'>编&nbsp;&nbsp;&nbsp;&nbsp;号</th>
						<td ><input name="meeting.code" type="text" value="<s:property value="meeting.code"/>"></td>
						<th width='15%'>密&nbsp;&nbsp;&nbsp;&nbsp;级</th>
						<td align="left">
							<select name="meeting.security" width="50">
								<s:iterator value="securityList" status="st">
								<s:if test="key == meeting.security">
					...
					<tr>	
						<th width='15%'>阶段标记</th>
						<td ><input name="meeting.stage" type="text" value="<s:property value="meeting.stage"/>"></td>													
						<th width='15%'>产品代号</th>
						<td ><input name="meeting.productCode" type="text" value="<s:property value="meeting.productCode"/>"></td>
					</tr>
					<tr>
						<th width='15%'>产品名称</th>
						<td ><input name="meeting.productName" type="text" value="<s:property value="meeting.productName"/>"></td>
						<th width='15%'>所属系统</th>
						<td ><input name="meeting.modelName" type="text" value="<s:property value="meeting.modelName"/>"></td>
					</tr>
					<tr>
						<th width='15%'>评审级别</th>
