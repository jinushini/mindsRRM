...
<script type="text/javascript">
	...
	jn(".dataAdd").click(function(){
		var $thisTbody = jn(".tbody");
		//新一行(新加一行)
		var $newTr = $thisTbody.find(".modelTr").clone();
...
<div class="pageContent">
	...
	<form method="post" action='../microwave/product_ProductOrder_modifyProdOrderList.action' class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
				...
				<tbody class="tbody" style="align:center">
					<s:iterator value="list" status="st">
						<tr target="id" rel="<s:property value="id"/>" class="modifyTr" align="center">
							...
							<td>
								<input type="text" name="productOrderListA[#index].libCode" value='<s:property value="libCode"/>'  style="width:96%;background-color:#F0F0F0;text-align:center;">
							</td>
							<td>
							...
							<td>
								<input type="text" name="productOrderListA[#index].code" value='<s:property value="code"/>'  style="width:96%;background-color:#F0F0F0;text-align:center;">
							</td>
							<td>
								<input type="text" name="productOrderListA[#index].selProdCode" value='<s:property value="selProdCode"/>'  style="width:96%;background-color:#F0F0F0;text-align:center;">
							</td>
							<td>
							...
							<td>
								<input name="productOrderListA[#index].singleHead.id" type="hidden" value='<s:property value="singleHead.id"/>'>
								<input name="productOrderListA[#index].singleHead.name" type="text" value='<s:property value="singleHead.name"/>' onclick="jd(this).next().click();" readonly="readonly" style="width:96%;background-color:#F0F0F0;text-align:center;">
				...
				<tbody class="tbody" style="align:center">
					<s:iterator value="list" status="st">
						<tr target="id" rel="<s:property value="id"/>" class="modifyTr" align="center">
							...
							<td>
								<input name="productOrderListA[#index].singleHead.id" type="hidden" value='<s:property value="singleHead.id"/>'  readonly="readonly">
								<input name="productOrderListA[#index].singleHead.name" type="text" value='<s:property value="singleHead.name"/>'  readonly="readonly" onclick="$(this).next().click()" style="width:96%;background-color:#F0F0F0;text-align:center;">
								<a title="人员选择" height="410" width="510"
									href="../system/user!findUser.action" target="dialog"
									rel="selectUser" resizable="false" maxable="false">
								</a>
			...
			<table id="child" border="0" width="150%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
				...
				<tbody class="tbody" style="align:center">
					<%-- <tr class="modelTr" style="display:none;" align="center">
						<td><input type="text" name="productOrderListA[#index].name" style="width:96%;background-color:#F0F0F0;text-align:center;"/></td>
						<td><input type="text" name="productOrderListA[#index].selProdCode" class="addRequired" style="width:96%;background-color:#F0F0F0;text-align:center;"/></td>
						<td><input type="text" name="productOrderListA[#index].orderNum" class="digits" style="width:96%;background-color:#F0F0F0;text-align:center;"/></td>
						<td>
						...
						<td>
							<input type="hidden" name="productOrderListA[#index].singleHead.id" readonly="readonly" >
							<input type="text" name="productOrderListA[#index].singleHead.name" readonly="readonly" onclick="$(this).next().click()" style="width:96%;background-color:#F0F0F0;text-align:center;">
						...
						<td><input type="text" name="productOrderListA[#index].outsourceUnit" value="微波所" class="outsourceUnit" readonly="readonly" style="width:96%;background-color:#F0F0F0;text-align:center;"/></td>
						<td><input type="text" name="productOrderListA[#index].outsourceUnitPIC" style="width:96%;background-color:#F0F0F0;text-align:center;"/></td>
						<td>
							<input type="hidden" name="productOrderListA[#index].designPlanManager.id" readonly="readonly" value="7049" class="designPlanManagerId">
							<input type="text" name="productOrderListA[#index].designPlanManager.name" readonly="readonly" value="张三" class="designPlanManagerName" style="width:96%;background-color:#F0F0F0;text-align:center;" onclick="$(this).next().click()">
							<a style="display:none;" type="hidden" title="人员选择" class="btnLook" height="410" width="510"
								href="../system/user!findUser.action" target="dialog"
								rel="selectUser" resizable="false" maxable="false"><span>人员选择</span>
							</a>
								...
								<table class="edit_table" align="center" style="table-layout:fixed;margin:-10px auto;margin-left:-9px;margin-right:-9px;">
									<s:iterator value="childProductOrderSet" status="st2" var="stv2">
										<tr target="id" rel='<s:property value="id"/>' class="modifyTr" align="center">
											...
											<td width="100"><input type="text" name="productOrderListA[#index].selProdCode" value='<s:property value="selProdCode"/>' class="required" style="width:96%;background-color:#F0F0F0;"/></td>
