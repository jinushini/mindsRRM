...
<div class="pageHeader">
	<form onsubmit="return dialogSearch(this);" action="../microwave/product_ProductOrder_showZhengjiOrderList_order-list-dialog.action" method="post">
	<div class="searchBar">
		<ul class="searchContent" >
			...
			<li>
				单机分类：<input type="text" name="paramMap['p.subType like']" value="<s:property value="paramMap['p.subType like']"/>" />
			</li>
			<li>
				主管设计师：<input type="text" name="paramMap['p.singleHead.name like']" value="<s:property value="paramMap['p.singleHead.name like']"/>" />
			</li>
			...
			<tbody>
			  <s:iterator value="list" status="st">
				<tr target="id" rel="<s:property value="id"/>">
					<td hidden="hidden"><input type="text" class="id" value="<s:property value='id'/>"/><input type="text" class="code" value="<s:property value='code'/>"/><input type="text" class="name" value="<s:property value='name'/>"/></td>
					...
					<td align="center"><s:property value="researchingMode"/></td>
					...
					<td align="center"><s:date name="planDeliveryTime" format="yyyy-MM-dd"/></td>
