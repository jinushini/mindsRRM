...
<script type="text/javascript">
	...
	jn("#newSelect").change(function(){
		...
		var url="../microwave/flow_ProductDesignProAppr_createProject_design-flow-input.action";
	...
	jn("#start").click(function(){
		...
		if(id == ""){
			...
			url = "../microwave/flow_ProductDesignProAppr_inputProject_design-flow-start.action?productDesignProId=" + id;
			jn(this).attr("href", url);
		}
	});
</script>
			...
			<tbody>
			  <s:iterator value="list" status="st">
				<tr target="id" rel="<s:property value="id"/>">
					...
					<td align="center">
						<a href="../microwave/flow_ProductDesignPro_showDetails_design-flow-show.action?id=<s:property value="id"/>" target="navTab" class="details">详情</a>
						<%-- &nbsp;| 
