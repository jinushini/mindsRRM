...
<script type="text/javascript">
	...
	jn("#newSelect").change(function(){
		...
		var url="../microwave/flow_ProductOrderProAppr_createProject_order-flow-input.action";
	...
	jn("#start").click(function(){
		...
		if(id == ""){
			...
			url = "../microwave/flow_ProductOrderProAppr_inputProject_order-flow-start.action?productOrderProId=" + id;
			jn(this).attr("href", url);
		}
	});
</script>
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					产品代号：<input type="text" name="paramMap['p.productOrder.productBasic.code like']" value="<s:property value="paramMap['p.productOrder.productBasic.code like']"/>" />
				</td>
				<td>
					产品名称：<input type="text" name="paramMap['p.productOrder.productBasic.name like']" value="<s:property value="paramMap['p.productOrder.productBasic.name like']"/>" />
				</td>
				<td>
			...
			<tbody>
			  <s:iterator value="list" status="st">
				<tr target="id" rel="<s:property value="id"/>">
					...
					<td align="center"><s:property value="productOrder.code"/></td>
					<td align="center"><s:property value="productOrder.name"/></td>
					...
					<td align="center">
						<a href="../microwave/flow_ProductOrderPro_showDetails_order-flow-show.action?id=<s:property value="id"/>" target="navTab" class="details">详情</a>
						<%-- &nbsp;| 
