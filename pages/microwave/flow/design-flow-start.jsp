...
<div class="pageContent">
  <form id="formdata" method="post" enctype="multipart/form-data" action='../microwave/flow_ProductDesignProAppr_saveAndSartProject.action' class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
	<input type="hidden" id="id" name="productDesignProId" value='<s:property value="productDesignPro.id"/>'/>
	<input type="hidden" id="processInstId" name="processInstId" value='<s:property value="productDesignPro.flowRun.processInstId"/>'/>
		...
		<fieldset>
			...
			<table bproduct="0" width="98%" class="edit_table" align="center">
				<tr>
					...
					<td hidden="hidden"><input type="hidden" name="id" value="<s:property value='productDesignPro.productDesign.id'/>" class="required" readonly="readonly"></td>
					<td>
						<input name="code" style="width:90%;" type="text" class="required" readonly="readonly" value="<s:property value='productDesignPro.productDesign.productBasic.code'/>" suggestFields="code,name,id" suggestUrl="" lookupGroup="productDesign" lookupPk="code" onclick="$(this).next().attr('href','../microwave/product_ProductDesign_showList_design-list-dialog.action');$(this).next().click()"/>
						<a title="选择产品" class="model" href="###" lookupGroup="" lookupPk="code" target="dialog" width="1080" height="600" ></a>
					</td>
					<td align="center">产品名称：</td>
					<td>
						<input name="name" style="width:90%;" type="text"  class="required" readonly="readonly" value="<s:property value='productDesignPro.productDesign.productBasic.name'/>" suggestFields="code,name,id" suggestUrl="" lookupGroup="productDesign" lookupPk="code" onclick="$(this).next().attr('href','../microwave/product_ProductDesign_showList_design-list-dialog.action');$(this).next().click()"/>
						<a title="选择产品" class="model" href="###" lookupGroup="" lookupPk="code" target="dialog" width="1080" height="600"></a>
					</td>
				</tr>
			...
			<legend>配置参数--<s:property value="productDesignPro.flowRun.flowName"/></legend>
			<table bproduct="0" width="98%" class="edit_table fluwRunConfig" align="center">
				...
				<s:iterator value="productDesignPro.flowRun.nodes" var="a">
