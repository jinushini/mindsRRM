		...
		<fieldset>
			...
			<table bproduct="0" width="98%" class="edit_table" align="center">
				<tr>
					...
					<td hidden="hidden"><input type="hidden" name="id" value="<s:property value='productOrderPro.productOrder.id'/>" class="required" readonly="readonly"></td>
					<td>
						<input name="code" style="width:90%;" type="text" class="required" readonly="readonly" value="<s:property value='productOrderPro.productOrder.code'/>" suggestFields="code,name,id" suggestUrl="" lookupGroup="productOrder" lookupPk="code" onclick="$(this).next().attr('href','../microwave/product_ProductOrder_showZhengjiOrderList_order-list-dialog.action');$(this).next().click()"/>
						<a title="选择产品" class="model" href="###" lookupGroup="" lookupPk="code" target="dialog" width="1080" height="600" ></a>
					</td>
					<td align="center">产品名称：</td>
					<td>
						<input name="name" style="width:90%;" type="text"  class="required" readonly="readonly" value="<s:property value='productOrderPro.productOrder.name'/>" suggestFields="code,name,id" suggestUrl="" lookupGroup="productOrder" lookupPk="code" onclick="$(this).next().attr('href','../microwave/product_ProductOrder_showZhengjiOrderList_order-list-dialog.action');$(this).next().click()"/>
						<a title="选择产品" class="model" href="###" lookupGroup="" lookupPk="code" target="dialog" width="1080" height="600"></a>
					</td>
				</tr>
