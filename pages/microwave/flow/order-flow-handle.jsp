...
<div class="pageContent">
  <form onsubmit="return navTabSearch(this);" action="<s:property value="page.url"/>" method="post">
	<div class="pageFormContent" layoutH="56">
		<br/>
		<fieldset>
			<legend>操作--<s:property value="productOrderPro.flowRun.flowName"/></legend>
			<table bproduct="0" width="98%" class="list_table list" style="margin:5px auto;">
				<tr>
					<th align="center" width="3%" style="display:none;">层级</th>
				...
				<s:iterator value="productOrderPro.flowRun.nodes" var="a" status="i">
					<tr style="background-color: #96ACC9;" class="node" id="a_<u:index value="#i.index+1"/>">
						<td style="font-size: 24px;display:none;" align="center">1</td>
						<td style="font-size: 24px;padding-left:10px;"><s:property value="#attr.a.flowDefName"/></td>
						<td align="center"></td>
					...
					<s:iterator value="#attr.a.flowRunDatas" var="b" status="j">
						<tr style="background-color: #BAD0EE;" class="customflow a_<u:index value="#i.index+1"/>" id="a_<u:index value="#i.index+1"/>_b_<u:index value="#j.index+1"/>">
							<td style="font-size: 19px;display:none;" align="center">2<input name="flowRunNodeVoList[#index].level" type="hidden" value="2"></td>
							<td style="font-size: 19px;padding-left:10px;"><s:property value="#attr.b.flowName"/></td>
							<td align="center"></td>
							<td align="center"><s:property value="scheduleDate.standardHours"/></td>
							<td align="center"><s:date name="scheduleDate.planBeginDate" format="yyyy-MM-dd"/></td>
							<td align="center"><s:date name="scheduleDate.planEndDate" format="yyyy-MM-dd"/></td>
						...
						<s:iterator value="#attr.b.subFlowRun.nodes" var="c" status="k">
							<tr style="background-color: #D8E6F7;" class="customnode a_<u:index value="#i.index+1"/> a_<u:index value="#i.index+1"/>_b_<u:index value="#j.index+1"/>" id="a_<u:index value="#i.index+1"/>_b_<u:index value="#j.index+1"/>_c_<u:index value="#k.index+1"/>">
								<td style="font-size: 16px;display:none;" align="center">3<input name="flowRunNodeVoList[#index].level" type="hidden" value="3"></td>
								<td style="font-size: 16px;padding-left:10px;"><s:property value="#attr.c.flowDefName"/></td>
								<td align="center"></td>
								<td align="center"><s:property value="scheduleDate.standardHours"/></td>
								<td align="center"><s:date name="scheduleDate.planBeginDate" format="yyyy-MM-dd"/></td>
								<td align="center"><s:date name="scheduleDate.planEndDate" format="yyyy-MM-dd"/></td>
							...
							<s:iterator value="#attr.c.flowRunDatas" var="d" status="m">
								<tr style="background-color: white;" class="actflow a_<u:index value="#i.index+1"/> a_<u:index value="#i.index+1"/>_b_<u:index value="#j.index+1"/> a_<u:index value="#i.index+1"/>_b_<u:index value="#j.index+1"/>_c_<u:index value="#k.index+1"/>" id="a_<u:index value="#i.index+1"/>_b_<u:index value="#j.index+1"/>_c_<u:index value="#k.index+1"/>_d_<u:index value="#m.index+1"/>">
									<td style="font-size: 14px;display:none;" align="center">4<input name="flowRunNodeVoList[#index].level" type="hidden" value="4"></td>
									<td style="font-size: 14px;padding-left:10px;"><s:property value="#attr.d.flowName"/></td>
									<td align="center">
									<s:if test="#b.status==5"></s:if><s:else>
