...
<div class="pageContent">
  <form method="post" action='../ssaps/ssapsAppr!handelForce.action' class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
	<input name="processInstId" type="hidden" value="<s:property value="productProducePro.flowRun.processInstId"/>">
	<div class="pageFormContent" layoutH="56">
		<br/>
		<fieldset>
			<legend style="font-size: 24px;">流程控制：<span style="font-size: 26px; color : red;"><s:property value="productProducePro.productProduce.productBasic.name"/>（<s:property value="productProducePro.productProduce.productBasic.code"/>）</span></legend>
			<div class="flow-frame">
				<s:iterator value="productProducePro.flowRun.nodes" status="st" var="a">
					<div class="stage">
