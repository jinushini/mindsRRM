...
<script type="text/javascript">
	...
	jn("#deleteBtn").click(function(){
		var productProduceProId = jn("#id").val();
		...
		<fieldset>
			...
			<table bproduct="0" width="98%" class="edit_table" align="center">
				<tr>
					...
					<td>
						<input name="code" style="width:90%;" type="text" class="required" readonly="readonly" value="" suggestFields="code,name,id" suggestUrl="" lookupGroup="productProduce" lookupPk="code" onclick="$(this).next().attr('href','../microwave/product_ProductProduce_showList_produce-list-dialog.action');$(this).next().click()"/>
						<a title="选择产品" class="model" href="###" lookupGroup="" lookupPk="code" target="dialog" width="1080" height="600" ></a>
					</td>
					<td align="center">产品名称：</td>
					<td>
						<input name="name" style="width:90%;" type="text"  class="required" readonly="readonly" value="" suggestFields="code,name,id" suggestUrl="" lookupGroup="productProduce" lookupPk="code" onclick="$(this).next().attr('href','../microwave/product_ProductDesign_showList_design-list-dialog.action');$(this).next().click()"/>
						<a title="选择产品" class="model" href="###" lookupGroup="" lookupPk="code" target="dialog" width="1080" height="600"></a>
					</td>
				</tr>
