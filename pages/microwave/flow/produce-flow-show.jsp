...
<div class="pageContent">
  <form onsubmit="return navTabSearch(this);" action="<s:property value="page.url"/>" method="post">
	<div class="pageFormContent" layoutH="56">
		<br/>
		<fieldset>
			<legend style="font-size: 24px;">流程详情：<span style="font-size: 26px; color : red;"><s:property value="productProducePro.productDesign.productBasic.name"/>（<s:property value="productProducePro.productDesign.productBasic.code"/>）</span></legend>
