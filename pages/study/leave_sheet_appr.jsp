...
<div class="pageContent">
  <form method="post" action="../study/leaveSheetAppr!leaderAppr.action"  class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
	...
	<fieldset>
		...
		<table border="0" width="98%" class="edit_table" align="center">
			<tr>
				...
				<td width="70%">
					<span class="required">
						<input type="radio" name="approve.resultCn" value="同意">同意&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="approve.resultCn" value="不同意">不同意
					</span>
				</td>
			</tr>
			<tr>
