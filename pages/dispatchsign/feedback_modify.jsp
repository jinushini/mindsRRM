	...
	jn("[name=del]").click(function(){
		...
		alertMsg.confirm("确认删除", {
			 okCall: function(){				
					...
					type : 'post',
					dataType : "json",
					url : "../dispatchSign/dispatchSignAppr!delFile.action",
					data:{
						id:fileId
					}, 
...
<form method="post" enctype="multipart/form-data" action='../dispatchSign/dispatchSignAppr!modifyFeedback.action' class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
		...
		<br/>
			<fieldset>
				...
				<table border="0" width="98%" class="edit_table" align="center">
					...
					<tr>
						<td align="center" rowspan="2">主持人意见：</td>	
						<td colspan="3"><s:property value="dispatch.host.name"/></td>
					</tr>
					<tr>
						<!-- <td align="center" rowspan="">审批意见：</td>	 -->
						<td colspan="3"><s:property value="dispatch.hostComments==null?'无':dispatch.hostComments"/></td>
					</tr>
					<tr>
						<td align="center" rowspan="2">产保意见：</td>	
						<td colspan="3"><s:property value="dispatch.productManager.name"/></td>
					</tr>
					<tr>
						<!-- <td align="center" rowspan="">审批意见：</td>	 -->
						<td colspan="3"><s:property value="dispatch.productManagerComments==null?'无':dispatch.productManagerComments"/></td>
					</tr>
				</table>
			</fieldset>
			<fieldset>
				...
				<table border="0" width="98%" class="edit_table" align="center" id="itemList">
					<tr>
						<td colspan="4">
							<textarea name="dispatch.feedbackInfo" id="feedbackInfo" class="editor required" rows="10" style="width: 100%;"
									upImgUrl="../dispatch/dispatchAppr!upload.action"
