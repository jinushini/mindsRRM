...
<div class="pageContent">
  <form action="../dispatchSign/dispatchSign!startOrderProcess.action" id="searchFrm" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" >
