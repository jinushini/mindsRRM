...
<div class="pageContent">
  <form method="post" action="../general/post_PostAppr_handle.action"  class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
	...
	<fieldset>
		...
		<table border="0" width="98%" class="edit_table" align="center">
			<tr>
				...
				<td width="70%">
					<s:property value="approve.result == 1 ? '通过' : '不通过'"/>
				</td>
			</tr>
			<tr>
				<td align="center">审批意见：</td>
				<td><s:property value="approve.resultCn"/></td>
			</tr>
		</table>
	</fieldset>
	...
	<fieldset>
		...
		<table border="0" width="98%" class="edit_table" align="center">
			<tr>
				<td  width="30%" align="center">处理结果：</td>
				<td width="70%">
					<span class="required">
						<input type="radio" name="result" value="0">已完成&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="result" value="1"/>未完成
					</span>
				</td>
			</tr>
		</table>
