	...
	jn("#newBuild").change(function(){
		switch(jn("#newBuild").val()){
			...
			case 'ssa_frequency':
				...
				navTab.openTab("", url, { title:"频率源模块图纸检查单", fresh:false, data:{} });
				break;	
			case 'ssa_frequencyB':
				jn("#newBuild").val("新建检查单");
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar" >
			...
			<li style="margin-right:5px;">
				<select style="width:120px;" id="changePage">
					<option value="allChecklist">所有检查单</option>
					<option value="stopedChecklist" selected>已终止检查单</option>
				</select>
			</li>
			
			<li style="margin-right:5px;">
				<select style="width:200px;" id="newBuild">
					<option value="新建检查单">———— 新建检查单 ————</option>
		...
		<!-- 			<option value="ssa_mmic_design_check">有源技术MMIC模块电路设计图纸复核检查单</option>	
					...
					<option value="ssa_frequencyB">频率源模块图纸检查单</option>
