				...
				<tr>
					<td align="center" colspan="6">
						<div style="width:100%;padding:3px 80px;">
							<label>型号名称</label><input type="text" name="checklist.modelCode" value="<s:property value="checklist.modelCode"/>" style="width:150px;">
							<label>单机名称</label><input type="text" name="checklist.productName" value="<s:property value="checklist.productName"/>" style="width:150px;">
						</div>
            		...
            		<td align="center">
            			<div class="new" >
            				...
            				<div style="width:100%;padding:3px 30px;float:left;">
            					...
            					<input type="radio" value="完全没有验证，但有仿真结果提供" name="checklist.newSingleBoardNote" style="margin-left:86px">完全没有验证
            					<input type="radio" value="有仿真结果需提供" name="checklist.newSingleBoardNote" style="margin-left:86px">有仿真结果需提供
            				</div>
            			</div>
					...
					<td>
						<label style="width:20%;margin-left:40px;">相对于同型号前阶段设计：</label>
            				<select name="checklist.changeSection" style="width:20%;margin-left:40px;">
            					<option value="电性星" >电性星</option>
            					<option value="鉴定件" >鉴定件有变化</option>
            					<option value="初样" >正样有变化</option>
            				</select>
					</td>
				</tr>
