		...
		<fieldset>
			...
			<table width="100%" class="list_table list" style="margin:5px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
				<thead>
					<tr align="center">
						<th width="15%">检查项目</th>
						<th width="20%">满足要求判据</th>
						<th width="30%">图纸检查落实情况</th>
				...
				<tbody class="tbody">
					<s:iterator value="checkResultList" status="st" >
						<tr target="id" rel="<s:property value="id"/>">
							...
							<td style="padding:5px 15px;"><s:property value='checkItem.num'/>.&nbsp;<s:property value='checkItem.demand'/>
								<s:if test="#st.index+1==5">
									<img src="lowpowresecure1.png" style="border:0;width:91%;font-size:15px;margin:4px 0 4px 4px;padding:5px;"/>
								</s:if>
								<s:if test="#st.index+1==8">
									<img src="lowpowresecure2.png" style="border:0;width:91%;font-size:15px;margin:4px 0 4px 4px;padding:5px;"/>
								</s:if>
								<s:if test="#st.index+1==9">
									<img src="lowpowresecure3.png" style="border:0;width:91%;font-size:15px;margin:4px 0 4px 4px;padding:5px;"/>
								</s:if>
							</td>
							<td style="padding:5px 15px;" >
								<div style="font-size:15px;"><s:property value='firstCheck'/>
								</div>
									<input type="text" style="border:0;width:95%;font-size:15px;margin:4px 0 4px 4px;padding:5px;" >
							</td>
