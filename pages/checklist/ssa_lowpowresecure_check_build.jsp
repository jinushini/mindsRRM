				...
				<tbody class="tbody">
					<s:iterator value="checkItemList" status="st">
						<tr>
							...
							<td style="padding:5px 15px;"><s:property value='num'/>.&nbsp;<s:property value='demand'/>
							...
							<td style="padding:5px 15px;" align="left" class="firstCheck"><input type="text" style="border:0;width:95%;font-size:15px;margin:4px 0 4px 4px;padding:5px;" ></td>
					</s:iterator>
				</tbody>
			</table>
		</fieldset>
