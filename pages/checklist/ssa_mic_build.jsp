	...
	jn("[name='checklist.isInherit']").change(function(){
		switch(jn(this).val()){
			...
			case '继承单板':
				...
				jn("#isOnFileChecked, #isClosedChecked, #changeSectionChecked").prop("checked", "checked");
				...
				jn("[name='checklist.changeSection']").change(function(){
					if((jn(this).val()=="有")){
						...
						jn(".tbody tr:gt(3) input").val("");
						jn(".tbody tr:gt(3)").hide();
					}
				})
				break;
			default:
		...
		<fieldset>
			<table width="98%" class="edit_table" style="margin:5px auto"> 
            		...
            		<td align="center">
            			<div class="new" >
            				<div style="width:100%;padding:3px 30px;float:left;">
            					...
            					<input type="radio" value="已进行了仿真" name="checklist.newSingleBoardNote" style="margin-left:63px">没有按照此电路板加工，但已经验证了其性能
            				</div>
            			</div>
				...
				<tr style="display:none;" class="inherit">
					...
					<td>
						<label style="width:25%;margin-left:40px;">继承单板图纸是否归档受控</label>
						<input type="radio" value="是" name="checklist.isOnFile" id="isOnFileChecked" checked>是
						<input type="radio" value="否" name="checklist.isOnFile">否
					</td>
				</tr>
				<tr style="display:none;" class="inherit">
					<td>
						<label style="width:25%;margin-left:40px;">继承单板三单是否闭环</label>
						<input type="radio" value="是" name="checklist.isClosedLoop" id="isClosedChecked" checked>是
						<input type="radio" value="否" name="checklist.isClosedLoop">否
					</td>
				</tr>
				<tr style="display:none;" class="inherit">
					<td>
						<label style="width:25%;margin-left:40px;">相对于继承单板有无变化</label>
						<input type="radio" value="有" name="checklist.changeSection" id="changeSectionChecked" checked>有
						<input type="radio" value="无" name="checklist.changeSection">无
					</td>
				</tr>
