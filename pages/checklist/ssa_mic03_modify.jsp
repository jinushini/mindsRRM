				...
				<table width="98%" class="edit_table" style="margin:5px auto"> 
					...
					<s:else>
						...
						<tr>
							...
							<td style="padding-left:5%;">继承单板图纸是否归档受控：<s:property value="checklist.isOnFile" /></td>
						</tr>
						<tr>
							<td style="padding-left:5%;">继承单板三单是否闭环：<s:property value="checklist.isClosedLoop" /></td>
						</tr>
						<tr>
							<td style="padding-left:5%;">
								<input type="hidden" value="<s:property value='checklist.changeSection' />" id="changeSection"/>
								相对于继承单板有无变化：<s:property value="checklist.changeSection" />
							</td>
						</tr>
						<tr class="Y">
