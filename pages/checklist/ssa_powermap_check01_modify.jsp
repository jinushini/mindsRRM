				...
				<tr>
					<td colspan="6">
						<div style="width:110%;padding:1px 15%;" >
							<label style="width: 25%;font-size:15px;">项目型号：<s:property value="checklist.modelCode"/></label>
							<label style="width: 25%;font-size:15px;">分机/单板名称：<s:property value="checklist.productName"/></label>
			...
			<table width="100%" class="list_table list" style="margin:5px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
				<thead>
					<tr align="center">
						<th width="11%">项目大类</th>
						<th width="30%">检查内容</th>
						<th width="15%" class="modify">设计师自查意见</th>
						<th width="15%" class="proof">校对人员意见</th>
