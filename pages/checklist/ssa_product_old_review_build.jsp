	...
	<div class="pageFormContent" layoutH="56">
		...
		<fieldset>
			<table width="98%" class="edit_table" style="margin:5px auto"> 
				...
				<tr>
					<td align="center" width="20%">基线产品</td>
					<td align="center">
						<input type="radio" value="该产品的电性产品" name="checklist.productGrade" style="margin-left:20px;" checked>该产品的电性产品
						<input type="radio" value="该产品的鉴定件产品" name="checklist.productGrade" style="margin-left:50px;">该产品的鉴定件产品
						<input type="radio" value="其他基线产品" name="checklist.productGrade" style="margin-left:50px;">其他基线产品
						<input type="text" name="checklist.productGrade"style="width:100px;float:right;height:14px; border:none #FFFFFF;border-bottom:#777777 solid 1px;background:transparent;"/>
					</td>
				</tr>
			</table>
		</fieldset>
