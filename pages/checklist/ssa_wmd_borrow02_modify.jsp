...
<script type="text/javascript">
	...
	if(jn("#changeSection input").val()=="电性星无变化"||jn("#changeSection input").val()=="鉴定件无变化"||jn("#changeSection input").val()=="正样无变化"){
		jn("[name='Y']").hide();
	...
	<div class="pageFormContent" layoutH="56">
		...
		<fieldset>
			<table width="98%" class="edit_table" style="margin:5px auto"> 
				...
				<tr>
				<s:if test="checklist.isInherit == '借用图纸'">
				...
				<s:elseif test="checklist.isInherit == '新设计图纸'">
					<td align="center" width="20%" id="isInherit"><s:property value="checklist.isInherit"/></td>
					<td></td>
				</tr>
				</s:elseif>
				<s:else>
					<td align="center" width="20%" id="isInherit" rowspan="4"><s:property value="checklist.isInherit"/></td>
					<td style="padding-left:5%;" id="changeSection">
						相对于同型号前阶段设计：<span><s:property value="checklist.changeSection" /></span>
						<input type="hidden" value="<s:property value='checklist.changeSection' />" />
					</td>
				</tr>
				<tr name="Y">
