	...
	<div class="pageFormContent" layoutH="56">
				...
				<tr>
					<td colspan="6">
						...
						<div style="width:110%;padding:1px 15%;" >
							...
							<label style="width: 25%;">产品等级：<s:property value="checklist.productGrade"/></label>
						</div>
					</td>
				</tr>
			</table>
					...
					<s:iterator value="checkResultList" status="st" >
						<tr target="id" rel="<s:property value="id"/>">
							...
							<td style="padding:5px 15px;" >
								...
								<s:if test="(#st.index+1==3)||(#st.index+1==5)||(#st.index+1==10)||(#st.index+1==11)||(#st.index+1==16)||(#st.index+1==18)||(#st.index+1==25)||(#st.index+1==28)||(#st.index+1==29)||(#st.index+1==37)">
									<input type="radio" value="是" />是
									<input type="radio" value="否" />否
									<input type="radio" value="不适用" />不适用
								</s:if>
								<s:elseif test="#st.index+1==8">
									<!-- <input type="radio" value="有，并提交了偏离申请"/>有，并提交了偏离申请<br/>
									<input type="radio" value="有，没有提交偏离申请"/>有，没有提交偏离申请<br/>
									<input type="radio" value="没有" />没有 -->
									<input type="radio" value="是" checked/>是
									<input type="radio" value="否" />否
									<input type="radio" value="不适用" />不适用
								</s:elseif>
								<s:elseif test="#st.index+1==15">
									<input type="text" style="border:0;width:93%;font-size:15px;margin:4px 0 4px 4px;padding:5px;"/>
								</s:elseif>
		...
		<fieldset>
			...
			<div style="margin:10px 10px;">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.对于检查存在问题的要形成待办事项跟踪表，并填写最终闭环情况。
			</div>
			<s:iterator value="relUserList" status="st">      
