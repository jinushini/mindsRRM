				...
				<tr>
					<td align="center" colspan="6">
						<div style="width:100%;padding:3px 80px;">
							<label>模块代号</label><input type="text" name="checklist.modelCode" value="<s:property value="checklist.modelCode"/>" style="width:150px;">
							<label>模块名称</label><input type="text" name="checklist.productName" value="<s:property value="checklist.productName"/>" style="width:150px;">
							<label>阶段</label><input type="text" name="checklist.stage" style="width:150px;">
						</div>
						<div style="width:100%;padding:3px 80px;float:left;">
							<td align="center">是否为新研模块：
								<input type="radio" value="是" name="checklist.checklistNum" style="margin-left:20px;" checked>是
								<input type="radio" value="否" name="checklist.checklistNum" style="margin-left:50px;">否
							</td>
						</div>
					</td>
				</tr>
						...
						<tr>
							...
							<td align="center" class="secondCheck">
								<s:if test="(#st.index+1==2)">
									<input type="checkbox" value="管壳改进" />管壳是否要改进
									<input type="checkbox" value="器件改动" />器件是否要改动
									<input type="checkbox" value="其他改动" />其他
								</s:if>
								<s:else>
