	...
	<div class="pageFormContent" layoutH="56">
		...
		<fieldset>
			<table width="98%" class="edit_table" style="margin:5px auto"> 
				<tr>
					<td align="center" colspan="6" style="font-size:13px;">单机（组件）环境试验条件<div style="font-size:23px;margin:10px "><s:property value="headline"/> ·V<s:property value="version"/>版</div></td>
				</tr>
				<tr>
					<td align="center" colspan="6" style="width:100%">
						<div style="width:100%;padding:3px 20px;">
							<label>所属型号</label><input type="text" name="checklist.modelCode" value="<s:property value="checklist.modelCode"/>" style="width:140px;">
						...
						<div style="width:100%;padding:3px 20px;float:left;">
							<label>单机编号</label><input type="text" name="checklist.productNum" style="width:140px;">
							<label>检查单编号</label><input type="text" name="checklist.checklistNum" style="width:140px;">
							<label>研制阶段</label>
							<select name="checklist.stage" style="width:147px;">
			...
			<table width="98%" class="list_table list" style="margin:5px auto">
				<tbody class="tbody">
					<s:iterator value="checkItemList" status="st">
						<tr>
							<td align="center" class="item"  width="30%"><s:property value='item'/></td>
							<td width="70%">
