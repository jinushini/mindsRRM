		...
		<div class="pageFormContent" layoutH="56">
			...
			<fieldset>
				<table width="98%" class="edit_table" style="margin:5px auto"> 
					...
					<tr>
						<td colspan="6">
							<div style="width:110%;padding:1px 15%;" >
								<label style="width: 25%;">模块名称：<s:property value="checklist.modelCode"/></label>
								<label style="width: 25%;">模块代号：<s:property value="checklist.productName"/></label>
								<label style="width: 25%;">阶段：<s:property value="checklist.stage"/></label>
								<label style="width: 25%;">成熟度：<s:property value="checklist.productCode"/></label>
							</div>
						</td>
					</tr>
					
									
					<s:if test="checklist.isInherit == '有基线模块'">
						<tr>
							<td align="center" width="20%">是否有基线模块</td>
							<td style="padding-left:5%;"><s:property value="checklist.newSingleBoardNote" /> </td>
							<td>	
								<div style="width:110%;padding-left:5%;">
	            					<label style="width: 40%;">与基线模块的变化内容：<s:property value="checklist.inheritExtensionName" /></label>
	            					<label style="width: 40%;">变化原因：<s:property value="checklist.inheritSingleBoardName" /></label>
	            				</div>
	            			</td>
						</tr>
					</s:if>
					<s:else>
						<tr>
							<td align="center" width="20%">有验证</td>
							<td style="padding-left:5%;"><s:property value="checklist.changeSection" /> </td>
							<td>
	            				<div style="width:110%;padding-left:5%;">
	            					<label style="width: 40%;">验证中出现的问题以及解决措施：<s:property value="checklist.inheritDrawingCode" /></label>
	            					<label style="width: 40%;">验证板与实际归档版有何不同及后续措施：<s:property value="checklist.inheritStage" /></label>
	            					<label style="width: 40%;">仿真是否全面，提供结果：<s:property value="checklist.inheritExtensionName" /></label>
	            				</div>
							</td>
						</tr>
					</s:else>
			...
			注：验证要求为A类模块不需验证、C类和D类模块必须验证、B类模块如仿真结果清晰，可不进行验证
		</div>
			<div style="border: solid #C5DBEC 1px ;padding:5px 0px;margin:15px 50px 20px;background-color:#DFE8F6; text-decoration: underline ;text-align: center;font-size: 16px;">
