...
<div class="pageContent">
	...
	<fieldset>
		<table width="98%" class="edit_table" style="margin:5px auto">
			...
			<tr>
				<td colspan="6">
					<div style="width:110%;padding:1px 15%;" >
						...
						<s:if test="checklist.isInherit == '是否有基线模块'">
				<tr>
			...
			<s:else>
				<tr>
					<td align="center" width="20%">是否验证</td>
					<td style="padding-left:5%;"><s:property value="checklist.changeSection" /> </td>
					<td>
						<div style="width:110%;padding-left:5%;">
	            			<label style="width: 40%;">验证中出现的问题：<s:property value="checklist.inheritExtensionName" /></label>
	            			<label style="width: 40%;">解决措施：<s:property value="checklist.inheritSingleBoardName" /></label>
	            		</div>
					</td>
				</tr>
			</s:else>
