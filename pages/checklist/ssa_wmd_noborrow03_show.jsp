...
<div class="pageContent">
	...
	<fieldset>
		<table width="98%" class="edit_table" style="margin:5px auto">
			...
			<tr>
			<s:if test="checklist.isInherit == '新设计图纸'">
				<td align="center" width="20%"><s:property value="checklist.isInherit"/></td>
				<td></td></tr>
			</s:if>
			<s:else>
				<td align="center" width="20%" rowspan="4"><s:property value="checklist.isInherit"/></td>
			...
			<tr>
				<td style="padding-left:5%;">三单落实情况：<s:property value="checklist.specialProblem" /></td>
			</tr>
			</s:else>
		</table>
	</fieldset>
