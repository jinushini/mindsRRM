			...
			<table width="98%" class="edit_table" style="margin:5px auto"> 
				...
				<tr>
					<td align="center" colspan="6">
						<div style="width:100%;padding:3px 80px;">
							...
							<label>成熟度</label><input type="text" name="checklist.productCode" style="width:150px;">
						</div>
					</td>
				</tr>
				...
				<tr>
					<td align="center" style="width:20%">
						<label>是否有基线模块</label><select name="checklist.isInherit" style="width:120px;margin-left:15px">
							<option value="有基线模块" >有基线模块</option>
							<option value="无基线模块" >无基线模块</option>
						</select>
					</td>
					<td align="center" style="width:20%">
						<label>是否验证</label><select name="checklist.isInherit" style="width:120px;margin-left:15px">
							<option value="有验证" >有验证</option>
							<option value="无验证" >无验证</option>
						</select>
					</td>
            		<td align="center">
            			<div class="new" >
            			...
            			<div class="inherit">
            				<div style="width:100%;padding:3px 30px;float:left;">
            					<input type="radio" value="已经完全按照已归档电路图加工并验证其性能" name="checklist.changeSection" style="margin-left:-240px" id="newChecked" checked >已经按此电路图加工并验证其性能
            					<input type="radio" value="没有按此电路图加工但已经验证部分性能" name="checklist.changeSection" style="margin-left:63px">没有按此电路图加工但已经验证其性能
            					<input type="radio" value="完全没有验证（只适用于成熟度B类模块）" name="checklist.changeSection" style="margin-left:63px">完全没有验证（只适用于成熟度B类模块）
            				</div>
            				<div style="width:100%;padding:3px 100px;float:left;">
            					<label>验证中出现的问题以及解决措施</label>
            					<input type="text" name="checklist.inheritDrawingCode" style="width:150px;" >
            					<label>验证板与实际归档版有何不同及后续措施</label>
            					<input type="text" name="checklist.inheritStage" style="width:150px;" >
            					<label>仿真是否全面，提供结果</label>
            					<input type="text" name="checklist.inheritExtensionName" style="width:150px;" >
            				</div>
            			</div>
            		</td>
