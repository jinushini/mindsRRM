				...
				<tr>
					<td colspan="6">
						<div style="width:110%;padding:1px 15%;" >
							<label style="width: 25%;font-size:15px;">型号：<s:property value="checklist.modelCode"/></label>
							<label style="width: 25%;font-size:15px;">分机名称：<s:property value="checklist.productName"/></label>
							<label style="width: 25%;font-size:15px;">图纸：<s:property value="checklist.drawingCode"/></label>
							<label style="width: 25%;font-size:15px;">阶段标：<s:property value="checklist.stage"/></label>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div style="width:110%;padding-left:5%;">
            				<label style="width: 40%;font-size:15px;"><s:property value="checklist.changeSection" /></label>
            			</div>
					</td>
				</tr>
			</table>
			...
			<table width="100%" class="list_table list" style="margin:5px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
				<thead>
					<tr align="center">
						<th width="11%">检查项目</th>
						<th width="40%">项目要求</th>
						<th width="20%" class="modify">设计师自查</th>
