			...
			<table width="98%" class="list_table list" style="margin:5px auto">
				...
				<tbody class="tbody">
					<s:iterator value="checkItemList" status="st">
						<tr>
							<td style="padding:5px 15px;"><s:property value='num'/>.&nbsp;<s:property value='item'/></td>
							<td style="padding:5px 15px;" align="center" class="firstCheck">
								<input type="radio" value="是" checked/>是
								<input type="radio" value="否" />否
							</td>
							<td align="center" class="secondCheck">
								<input type="text" style="border:0;width:97%;font-size:15px;margin:4px 0 4px 4px;padding:5px;"/>
							</td>
						</tr>
					</s:iterator>
				</tbody>
