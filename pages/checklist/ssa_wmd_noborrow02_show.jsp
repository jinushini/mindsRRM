...
<script type="text/javascript">
	...
	jn(function(){
		...
		if(jd("#changeSection input").val()=="电性星无变化"||jd("#changeSection input").val()=="鉴定件无变化"||jd("#changeSection input").val()=="正样无变化"){
			jd("[name='Y']").hide();
		...
		<fieldset>
			<table width="98%" class="edit_table" style="margin:5px auto"> 
				...
				<s:elseif test="checklist.isInherit == '新设计图纸'">
					...
					<td style="padding-left:5%;" id="changeSection">相对于同型号前阶段设计：<span><s:property value="checklist.changeSection" /></span></td>
				</tr>
				<tr name="Y">
				...
				<s:iterator value="checkResultList" status="st" >
						...
						<tr>
							...
							<td style="padding:5px 15px;font-size:15px;" name="audit">
								<span><s:property value='thirdCheck'/></span>
							</td>
						</tr>
				</s:iterator>
			</table>
