...
<script type="text/javascript">
	...
	jn("[name='checklist.isInherit']").change(function(){
		switch(jn(this).val()){
			case '借用图纸':
				jn("[name='checklist.checklistType']").val("ssa_design_check");
				...
				break;
			case '新设计图纸':
				jn("[name='checklist.checklistType']").val("ssa_design_nocheck");
				jn(".isInherit").attr("rowspan","1");
				//清空隐藏更改图纸部分
				jn(".alter input").val("");
				jn(".alter [name='checklist.changeSection']").val("");
			...
			<table width="98%" class="edit_table" style="margin:5px auto"> 
				...
				<tr>
					<td align="center" colspan="6">
						<div style="font:18px;width:100%;padding:4px 80px;">
						...
						<div style="width:100%;padding:4px 80px;float:left;">
						</div>
					</td>
				</tr>
				<tr>
