			...
			<tr>
				<td colspan="6">
					<div style="width:110%;padding:1px 15%;" >
						<label style="width: 25%;font-size:15px;"">型号代号：<s:property value="checklist.modelCode"/></label>
						<label style="width: 25%;font-size:15px;"">产品名称：<s:property value="checklist.productName"/></label>
						<label style="width: 25%;font-size:15px;"">产品代号：<s:property value="checklist.productCode"/></label>
					</div>
					<div style="width:110%;padding:1px 15%;" >
						<label style="width: 25%;font-size:15px;"">图纸代号：<s:property value="checklist.drawingCode"/></label>
						<label style="width: 25%;font-size:15px;"">研制阶段：<s:property value="checklist.stage"/></label>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div style="width:110%;padding-left:5%;">
           				<label style="width: 40%;font-size:15px;">借用分机名称：<s:property value="checklist.inheritExtensionName" /></label>
           				<label style="width: 40%;font-size:15px;">单板名称：<s:property value="checklist.inheritSingleBoardName" /></label>
           			</div>
           			<div style="width:110%;padding-left:5%;">
           				<label style="width: 40%;font-size:15px;">图纸代号：<s:property value="checklist.inheritDrawingCode" /></label>
           				<label style="width: 40%;font-size:15px;">研制阶段：<s:property value="checklist.inheritStage" /></label>
           			</div>
				</td>
			</tr>
		</table>
