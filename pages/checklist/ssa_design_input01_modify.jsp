	...
	<div class="pageFormContent" layoutH="56">
		...
		<fieldset>
			...
			<table width="100%" class="list_table list" style="margin:5px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
				<thead>
					<tr align="center">
						<th width="20%">工作项目与内容</th>
						<th width="15%">检查结果</th>
						<th width="30%">存在问题</th>
						<th width="7%" class="isClosedLoop" style="display:none;">是否闭环</th>
				...
				<tbody class="tbody">
					<s:iterator value="checkResultList" status="st" >
						<tr target="id" rel="<s:property value="id"/>">
							<td style="padding:5px 15px;"><s:property value='checkItem.num'/>.&nbsp;<s:property value='checkItem.item'/></td>
