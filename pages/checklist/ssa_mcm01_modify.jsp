				...
				<table width="98%" class="edit_table" style="margin:5px auto"> 
					...
					<s:else>
						<tr>
							...
							<td>
	            				<div style="width:110%;padding-left:5%;">
	            					<label style="width: 40%;">验证中出现的问题：<s:property value="checklist.inheritDrawingCode" /></label>
	            					<label style="width: 40%;">解决措施：<s:property value="checklist.inheritStage" /></label>
	            				</div>
