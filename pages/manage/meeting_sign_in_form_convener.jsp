...
<!--	
	...
	//直接闭环，不填纪要
	jn("#endBtn").click(function(){
		alertMsg.confirm("确定不需要填写会议纪要吗？2019年12月1号以后启动的会议生效", {
			okCall : function(){
				jn("#hashSummary").val(0);
				jn("#submitBtn").click();
			},
			cancelCall : function() {
				jn("#hashSummary").val(1);
			}
		});	
	})
//-->
...
<div class="pageContent">
	<form method="post" id="searchFrm" action="../manage/weeklyMeetingAppr!signIn.action" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<input type="hidden" id="hashSummary" name="hashSummary" value="1">
		...
		<ul style="">
			...
			<li style="float: left;"><div class="buttonActive"><div class="buttonContent"><button id="endBtn" type="button">直接闭环</button></div></div></li>
