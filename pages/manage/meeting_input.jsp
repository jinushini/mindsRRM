...
<div class="pageContent">
 	<form method="post" enctype="multipart/form-data" id="form" action="../manage/weeklyMeeting!startMeetingProcess.action" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);"> 
		...
		<fieldset>		
			...
			<table class="list_table edit_table" width="98%" id="itemList">
				<tbody>
					<tr>
						<th width='15%'>会议主题</th>
						<td colspan="2"><input name="meeting.subject" type="text" class="required" readonly="readonly" placeholder="请在上图拖拽创建会议主题" style="width:98%">
						</td>
						<td><input name="meeting.category" type="checkbox" class="required" value="微波所周例会">&nbsp;&nbsp;微波所周例会
						</td>
					</tr>
					...
					<tr>
						...
						<th width='15%'>会议地点</th>
							<!-- <input name="meeting.address" style="width:70%;" type="text" readonly="readonly" class="required"/> -->
		...
		<div class="formBar">
			<ul>
				...
				<li><div class="buttonActive"><div class="buttonContent"><button id="submitBtn" type="submit">启动会议</button></div></div></li>
 				<li><a class="button" href="../manage/weeklyMeeting!showMeetingList.action?a=a&b=b"  target="navTab"><span>返回</span></a>
			</ul>
		</div>
	</form>
</div>
