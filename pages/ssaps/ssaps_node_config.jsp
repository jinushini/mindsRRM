				...
				success : function(data, statusText) {
					...
					for(var i=0;i<data.flowModel.flowModelNodes.length;i++){
						...
						coinSet = coinSet + "<div style='font-size:15px;width:100%;'>"
											...
											+ "<label style='width:60%;text-align:right;float:left;'>" + flowModelNode.nodesName + ":</label><input type='text' name='subFlowList[#index].coinList[#seq].quantity' value='" + flowModelNode.nodeCoin + "' style='padding:1px 1px; border:1px solid #ccc; height:15px; width:30%;float:right;'/><br/>"
				                          + "</div>";
					}
					var $coinSet = $(coinSet);
					$coinSet.initUI();
								...
								<td class="coinSet" style="padding:5px 3px;">
									<s:iterator value="coinSet" >
										<div style="font-size:15px;width:100%">
											...
											<input type="text" name="nodesDataList[#index].coinList[#seq].quantity" value="<s:property value='quantity'/>" style="padding:1px 1px; border:1px solid #ccc; height:15px; width:30%;float:right;"/>	<br/>
										</div>
									</s:iterator>
								</td>
							</tr>
