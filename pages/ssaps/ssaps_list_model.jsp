...
<script type="text/javascript">
	...
	<input id="processInstId" type="hidden" name="processInstId" value="<s:property value="ssaps.processInstId"/>">
	<input id="flowClassId" type="hidden" name="flowClassId" value="<s:property value="#attr.b.subClassId"/>" readonly="readonly">
	<input id="flowClassName" type="hidden" name="flowClassName" value="<s:property value="#attr.b.subClassName"/>" readonly="readonly">
