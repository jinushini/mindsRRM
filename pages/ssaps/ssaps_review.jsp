...
<script type="text/javascript">
	jn(function(){		
		...
		jn(".setUserA").click(function(){
			...
			var url = "../ssaps/ssapsConfig!inputSubProcessAuditor.action?subFlowId="+subFlowId;
					...
					<div class="stage">
						<div id="<u:index value='#st.index+1'/>">
							<h1><s:property value="#attr.a.nodesName"/>
								<a href="../ssaps/ssaps!inputModifySsapsNode.action?ssapsNodeId=<s:property value="#attr.a.id"/>" width="750" target="dialog"><input type="hidden" value="<s:property value="#attr.a.id"/>"><img src="../../img/edit.gif"></a>
								<a href="../ssaps/ssapsConfig!inputSuperFlowNodeConfig.action?parentNodeId=<s:property value="#attr.a.id"/>&&processInstId=<s:property value="processInstId"/>" target="dialog" width="750" title="新增子任务"><img src="../../img/new.gif"></a>
								...
								<s:iterator value="#attr.a.ssapsNodeDatas" var="b">
									<li>
										...
										<s:if test="#attr.b.status==5">
											<a class="setUserA" style="display:" title="设置人员" target="dialog" ><img src="../../img/setting.gif"></a>
