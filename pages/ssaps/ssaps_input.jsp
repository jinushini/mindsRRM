	...
	<fieldset>
		...
		<table bproduct="0" width="98%" class="edit_table" align="center">
			<tr>
				...
				<td hidden="hidden"><input type="hidden" name="product.id" value="" class="required" readonly="readonly"></td>
				<td>
					<input name="product.code" style="width:90%;" type="text" class="required" readonly="readonly" value="" suggestFields="code,name,id" suggestUrl="" lookupGroup="product" lookupPk="code" onclick="$(this).next().attr('href','../product/product!showListForDialog.action');$(this).next().click()"/>
					<a title="选择产品" class="model" href="###" lookupGroup="product" lookupPk="code" target="dialog" width="1080" height="600" ></a>
				</td>
				<td align="center">产品名称：</td>
				<td>
					<input type="text" name="product.name" class="required" readonly="readonly" value="" suggestFields="code,name,id" suggestUrl="" lookupGroup="product" lookupPk="code" onclick="$(this).next().attr('href','../product/product!showListForDialog.action');$(this).next().click()"/>
					<a title="选择产品" class="model" href="###" lookupGroup="product" lookupPk="code" target="dialog" width="1080" height="600"></a>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3">
					<input name="ssaps.responsibleId" type="hidden" class="required">
					<input name="ssaps.responsibleName" type="text" onclick="$(this).next().click()" readonly="readonly" class="required">
