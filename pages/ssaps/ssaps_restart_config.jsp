...
<div class="pageContent">
  <form method="post" action='../ssaps/ssapsController!reStartSubProcess.action' class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	...
	<div class="pageFormContent" layoutH="56">
		<br/>
	<fieldset>
		<legend><s:property value="ssapsNodeData.flowName"/>--参数修改</legend>
		<table bssaps="0" width="98%" class="edit_table" align="center">
			...
			<tr>
				...
				<td><input name="wasteVo.scheduleDate.manHours" type="text" class="dates" value="<s:property value="ssapsNodeData.scheduleDate.manHours"/>"></td>
			</tr>
			<tr>
