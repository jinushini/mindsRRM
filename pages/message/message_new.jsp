...
<!--
	...
	jn("[name=look]").click(function(){
		...
		var options={};
		 options.width = 600;
		 options.height = 500;
		var url="../inform/message!displayMsg.action?msgId="+$trObj.attr("rel")+"&flag=1";
		$.pdialog.open(url, "new_msg", "查看新消息", options);
	}); 
//-->
</script>
			...
			<tbody>
			  <s:iterator value="list" status="st">
				<tr target="id" rel="<s:property value="id"/>">			
					...
					<td align="center" style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><s:property value="title"/></td>
					<td align="center" title="<s:property value="contentStr"/>" style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><s:property value="contentStr"/></td>
					...
					<%-- <td align="center"><a href='../inform/message!newreply.action?msgId=<s:property value="id"/>' target="ajaxTodo">确认</a></td> --%>
					<td align="center"><a href="javascript:;" height="450" width="400" name="look">查看</a></td>
				</tr>
			  </s:iterator>
			 </tbody>
		</table>
