...
<div class="pageContent">
  <form action="../designInfo/Mhic_ModifyMhicDetail_mhic.action" method="post" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
		...
		<legend style="font-size:16px;">MHIC基本信息</legend>
			<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
				...
				<tr>
					...
					<td>
						<input type="text" class="required" style="width:97%;background-color:#F0F0F0;" value="<s:property value='mhic.name'/>" name="mhic.name" />
						<%-- <s:property value='mhic.name'/> --%>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" class="required" style="width:97%;background-color:#F0F0F0;" value="<s:property value='mhic.packageForm'/>" name="mhic.packageForm" />
					</td>
				</tr>
				<tr>
					<td align="center" style="width:20%;background-color:#E4F0FC;font-size:17px;">产品简介</td>
					<td><textarea class="editor" tools="Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,SelectAll,Removeformat,Align,Outdent,Indent,Fullscreen" name="mhic.introduction" rows="7" class="required" style="width:97%;background-color:#F0F0F0;" ><s:property value='mhic.introduction'/></textarea></td>
				</tr>
			</table>
	</fieldset>
	<br/>
	...
	<fieldset>
		...
		<table width="97%" class="edit_table" style="margin:15px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
			<tr align="center">
				...
				<td><input type="text" name="mhic.eleParamCondition" value="<s:property value='mhic.eleParamCondition' />" style="width:97%;background-color:#F0F0F0;align:center;" /></td>
			</tr>
			<tr align="center">
				<td width="20%" style="background-color:#E4F0FC;font-weight: bold;">电参数说明</td>
				<%-- <td><textarea name="mhic.eleParamExplain" rows="3" style="width:97%;background-color:#F0F0F0;" ><s:property value='mhic.eleParamExplain'/></textarea></td> --%>
				<td><textarea class="editor" name="mhic.eleParamExplain" rows="7" class="required" style="width:97%;background-color:#F0F0F0;" ><s:property value='mhic.eleParamExplain'/></textarea></td>
			</tr>
		</table>
		<table width="97%" class="edit_table" style="margin:15px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
	...
	<fieldset>
		...
		<table width="97%" class="edit_table" style="margin:15px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
			...
			<tbody class="tbody">
				...
				<s:iterator value="mhic.attentionSet" status="st" var="a">
					<tr class="modifyTr" align="center">
	...
	<br/>
	<fieldset>
		<legend style="font-size:16px;" id="cankaodianlu">外围参考电路&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行<span style="color:red;font-size:14px;">（仅支持上传jpg和png格式的图片）</span></a></legend>
		<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
