...
<div class="pageContent" layoutH="20">
	<form action="../designInfo/Mhic_funClone_mhic.action" method="post" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);" >
		<input type="hidden" name="num" value="<s:property value="mhic.id"/>" />
		<div layoutH="70" style="margin:30px 30px -25px; font-size:16px;line-height: 28px;">		
			请在下面输入框中填写有效产品代号（每行填一个，无效产品代号被忽略）<br/>
			提交成功后，<span style="color:red;font-size:20px"><s:property value="mhic.code"/></span>的各项性能将被复制到输入框中的每个产品上
