...
<div class="pageContent" >
	<div class="panelBar">
		<ul class="toolBar">
			<li><a title="MCM发射部件目录编辑" href="../designInfo/Mcm_showMcm_mcm_mcmT-catalog-show.action?num={id}" class="icon" target="dialog" height="680" width="600"><span>目录编辑</span></a></li>
		</ul>
	</div>
	<div layoutH="90">
		<table class="list_table list" width="200%" layoutH="145" style="table-layout:fixed;">
			<thead>
				<tr>
					<th width="20">序号</th>
					...
					<th width="100">发射增益(dB)</th>
					<th width="100">发射噪声系数(dB)</th>
			...
			<tbody>
			  <s:iterator value="list" status="st">
				<tr target="id" rel="<s:property value="id"/>" >
					...
					<td align="center"><span><s:property value="gianEmit"/></span></td>
					<td align="center"><span><s:property value="noiseFigureEmit"/></span></td>
