	...
	<form action="../designInfo/Mcm_modifyCatalog_mcm_mcmR-list-catalog.action" method="post" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);" >
		...
		<div layoutH="40">
			<table width="95%" class="edit_table" style="table-layout:fixed;margin:10px 25px auto;">
				...
				<tr>
					<td align="right" style="width:25%;border:hidden;">带宽(GHz)：</td>
					<td style="border:hidden;" style="border:hidden;">
				...
				<tr>
					<td align="right" style="width:25%;border:hidden;">镜频抑制(dB)：</td>
					<td style="border:hidden;" style="border:hidden;">
						<input type="text" name="mcm.imageFreqReject" value="<s:property value='mcm.imageFreqReject'/>" style="width:250px;text-align: center;" onblur="value=value.match(/\-?\d+\.?\d{0,3}/)" placeholder="数字">
					</td>
				</tr>
				<tr>
