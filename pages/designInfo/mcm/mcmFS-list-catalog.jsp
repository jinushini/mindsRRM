				...
				<tr>
					...
					<td style="width: 20%;padding:0px 0px 1px;border:hidden;border:hidden;">
						<select name="data" id="type" style="width:80%;">
							...
							<option value="MCM-FS" selected>MCM-FS</option>
						</select>
					</td>
...
<div class="pageContent" >
	<div class="panelBar">
		<ul class="toolBar">
			<li><a title="MCM 本振部件目录编辑" href="../designInfo/Mcm_showMcm_mcm_mcmFS-catalog-show.action?num={id}" class="icon" target="dialog" height="520" width="600"><span>目录编辑</span></a></li>
		</ul>
	</div>
	<div layoutH="90">
		<table class="list_table list mcmList" width="200%" layoutH="145" style="table-layout:fixed;">
			<thead>
				<tr>
					...
					<th width="100">输出功率(dBm)</th>
					<th width="100">谐波抑制dBc(TPY)</th>
					<th width="100">杂波抑制dBc(TPY)</th>
					<th width="100">相位噪声(dBc/Hz@10kHz)</th>
					<th width="100">功耗(V/mA)(mW)</th>
					<th width="100">参考频率(mHz)</th>
					<th width="100">参考功率(dBm)</th>
					<th width="70">操作</th>
				</tr>
			</thead>
			<tbody>
			  <s:iterator value="list" status="st">
				<tr target="id" rel="<s:property value="id"/>" >
					...
					<td align="center"><s:property value="code"/></span></td>	
					<td align="center"><span><s:property value="name"/></span></td>
					<td align="center"><span><s:property value="freqOutMin"/>~<s:property value="freqOutMax"/></span></td>
					<td align="center"><span><s:property value="powerOutMin"/>~<s:property value="powerOutMax"/></span></td>
					<td align="center"><span><s:property value="harmonicReject"/></span></td>
					<td align="center"><span><s:property value="clutterReject"/></span></td>
					<td align="center"><span><s:property value="phaseNoise"/></span></td>
					<td align="center"><span><s:property value="powerConsume"/></span></td>
					<td align="center"><span><s:property value="freqRefer"/></span></td>
					<td align="center"><span><s:property value="powerReferMin"/>~<s:property value="powerReferMax"/></span></td>
					<td align="center">
