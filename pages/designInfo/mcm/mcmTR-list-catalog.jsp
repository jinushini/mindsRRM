				...
				<tr>
					...
					<td style="width: 20%;padding:0px 0px 1px;border:hidden;border:hidden;">
						<select name="data" id="type" style="width:80%;">
							...
							<option value="MCM-TR" selected>MCM-TR</option>
...
<div class="pageContent" >
	<div class="panelBar">
		<ul class="toolBar">
			<li><a title="MCM TR部件目录编辑" href="../designInfo/Mcm_showMcm_mcm_mcmTR-catalog-show.action?num={id}" class="icon" target="dialog" height="640" width="600"><span>目录编辑</span></a></li>
		</ul>
	</div>
	<div layoutH="90">
		<table class="list_table list mcmList" width="150%" layoutH="145" style="table-layout:fixed;">
			<thead>
				<tr>
					<th width="40">序号</th>
					<th width="100">产品代号</th>
					<th width="100">工作频率(GHz)</th>
					<th width="100">接收增益(dB)</th>
					<th width="100">接收噪声系数(dB)</th>
					<!-- <th width="100">发射功率(dBm)</th> -->
					<th width="100">发射效率(%)</th>
					<th width="100">功耗(V/mA)</th>
					<th width="100">幅度特性(bit,dB)</th>
					<th width="100">相移特性(bit,°)</th>
					<th width="70">操作</th>
				</tr>
			</thead>
			<tbody>
			  <s:iterator value="list" status="st">
				<tr target="id" rel="<s:property value="id"/>" >
					...
					<td align="center"><span><s:property value="freqWorkMin"/>~<s:property value="freqWorkMax"/></span></td>
					<td align="center"><span><s:property value="gainRec"/></span></td>
					<td align="center"><span><s:property value="noiseFigureRec"/></span></td>
					<%-- <td align="center"><span><s:property value="powerEmit"/></span></td> --%>
					<td align="center"><span><s:property value="effEmit"/></span></td>
					<td align="center"><span><s:property value="powerConsume"/></span></td>
					<td align="center"><span>(<s:property value="ampBit"/>,<s:property value="ampRange"/>),步进<s:property value="ampStep"/>dB</span></td>
					<td align="center"><span>(<s:property value="phaseShiftBit"/>,<s:property value="phaseShiftRange"/>),步进<s:property value="phaseShiftStep"/>dB</span></td>
					<td align="center">
