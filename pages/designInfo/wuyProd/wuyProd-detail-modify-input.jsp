...
<script type="text/javascript">
	...
	jn(".dataAdd").click(function(){
		...
		if($thisLegend.attr("id")=="cankaodianlu" && $thisTbody.find("tr:visible").length>0){
			alertMsg.error("最多上传一张外围参考电路图！");
			return false;
		} */
...
<div class="pageContent">
  <form action="../designInfo/WuyProd_ModifyWuyProdDetail_wuyProd.action" method="post" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
		...
		<legend style="font-size:16px;">无源产品基本信息</legend>
			<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
				...
				<tr>
					...
					<td>
						<input type="text" class="required" style="width:97%;background-color:#F0F0F0;" value="<s:property value='wuyProd.name'/>" name="wuyProd.name" />
						<%-- <s:property value='wuyProd.name'/> --%>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" class="required" style="width:97%;background-color:#F0F0F0;" value="<s:property value='wuyProd.interfaceForm'/>" name="wuyProd.interfaceForm" />
					</td>
				</tr>
				<tr>
					<td align="center" style="width:20%;background-color:#E4F0FC;font-size:17px;">产品简介</td>
					<td><textarea class="editor" tools="Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,SelectAll,Removeformat,Align,Outdent,Indent,Fullscreen" name="wuyProd.introduction" rows="7" class="required" style="width:97%;background-color:#F0F0F0;" ><s:property value='wuyProd.introduction'/></textarea></td>
				</tr>
			</table>
	</fieldset>
	<br/>
	<fieldset>
		<legend style="font-size:16px;">原理框图&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行<span style="color:red;font-size:14px;">（仅支持上传jpg和png格式的图片）</span></a></legend>
		<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
					<th width="50%" style="font-size:17px;">原理框图</th>
			...
			<tbody class="tbody">
				<tr class="modelTr" style="display:none;" align="center">
					...
					<td style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
						<input type="hidden" name="designFileListA[#index].type" value="原理框图" />
	...
	<fieldset>
		...
		<table width="97%" class="edit_table" style="margin:15px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
			<tr align="center">
				...
				<td><input type="text" name="wuyProd.eleParamCondition" value="<s:property value='wuyProd.eleParamCondition' />" style="width:97%;background-color:#F0F0F0;align:center;" /></td>
			</tr>
			<tr align="center">
				<td width="20%" style="background-color:#E4F0FC;font-weight: bold;">电参数说明</td>
				<td><textarea name="wuyProd.eleParamExplain" rows="3" style="width:97%;background-color:#F0F0F0;" ><s:property value='wuyProd.eleParamExplain'/></textarea></td>
				<td><textarea class="editor" name="wuyProd.eleParamExplain" rows="7" class="required" style="width:97%;background-color:#F0F0F0;" ><s:property value='wuyProd.eleParamExplain'/></textarea></td>
			</tr>
		</table>
		<table width="97%" class="edit_table" style="margin:15px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
	...
	<br/>
	<fieldset>
		<legend style="font-size:16px;">性能指标&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行<span style="color:red;font-size:14px;">（仅支持上传jpg和png格式的图片）</span></a></legend>
		<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
					<th width="50%" style="font-size:17px;">性能指标</th>
					<th width="40%" style="font-size:17px;">图片说明</th>
					<th width="5%" style="font-size:17px;">操作</th>
				</tr>
			</thead>
			<tbody class="tbody">
				<tr class="modelTr" style="display:none;" align="center">
					...
					<td style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
						<input type="hidden" name="designFileListB[#index].type" value="性能指标" />
	...
	<br/>
	<fieldset>
		<legend style="font-size:16px;">仿真模型&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行<span style="color:red;font-size:14px;">（仅支持上传jpg和png格式的图片）</span></a></legend>
		<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
					<th width="50%" style="font-size:17px;">仿真模型</th>
					<th width="40%" style="font-size:17px;">图片说明</th>
					<th width="5%" style="font-size:17px;">操作</th>
				</tr>
			</thead>
			<tbody class="tbody">
				<tr class="modelTr" style="display:none;" align="center">
					...
					<td style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
						<input type="hidden" name="designFileListC[#index].type" value="仿真模型" />
	...
	<br/>
	<fieldset>
		<legend style="font-size:16px;">性能曲线&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行<span style="color:red;font-size:14px;">（仅支持上传jpg和png格式的图片）</span></a></legend>
		<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
					<th width="50%" style="font-size:17px;">性能曲线</th>
					<th width="40%" style="font-size:17px;">图片说明</th>
					<th width="5%" style="font-size:17px;">操作</th>
				</tr>
			</thead>
			<tbody class="tbody">
				<tr class="modelTr" style="display:none;" align="center">
					<td class="num">
						<div style="font-size:15px;margin:8px auto;" ></div>
						<input type="hidden" name="designFileListD[#index].num" />
					</td>
					<td style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
						<input type="hidden" name="designFileListD[#index].type" value="性能曲线" />
						<input type="file" name="fileD" accept="image/jpeg,image/png" />
					</td>
					<td>
						<input type="text" class="explain" name="designFileListD[#index].explain" style="width:97%;background-color:#F0F0F0;text-align:center;" />
					</td>
					<td><a class="delBtn" href="javascript:;" style="color : red;">删除</a></td>
				</tr>
				<s:iterator value="wuyProd.designFileSet" status="st">
	...
	<br/>
	<fieldset>
		<legend style="font-size:16px;">外形图片&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行<span style="color:red;font-size:14px;">（仅支持上传jpg和png格式的图片）</span></a></legend>
		<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
					<th width="50%" style="font-size:17px;">外形图片</th>
					<th width="40%" style="font-size:17px;">图片说明</th>
					<th width="5%" style="font-size:17px;">操作</th>
				</tr>
			</thead>
			<tbody class="tbody">
				<tr class="modelTr" style="display:none;" align="center">
					<td class="num">
						<div style="font-size:15px;margin:8px auto;" ></div>
						<input type="hidden" name="designFileListE[#index].num" />
					</td>
					<td style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
						<input type="hidden" name="designFileListE[#index].type" value="外形图片" />
						<input type="file" name="fileE" accept="image/jpeg,image/png" />
					</td>
					<td>
						<input type="text" class="explain" name="designFileListE[#index].explain" style="width:97%;background-color:#F0F0F0;text-align:center;" />
					</td>
					<td><a class="delBtn" href="javascript:;" style="color : red;">删除</a></td>
				</tr>
				<s:iterator value="wuyProd.designFileSet" status="st">
	...
	<%-- <br/>
	<fieldset>
		<legend style="font-size:16px;">接口信息&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行</a></legend>
		<table width="97%" class="edit_table" style="margin:15px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
	...
	<fieldset>
		...
		<table width="97%" class="edit_table" style="margin:15px auto;table-layout:fixed;word-break:break-all;word-warp:break-word;">
			...
			<tbody class="tbody">
				...
				<s:iterator value="wuyProd.attentionSet" status="st" var="a">
					<tr class="modifyTr" align="center">
	...
	<br/>
	<fieldset>
		<legend style="font-size:16px;">外围参考电路&nbsp;&nbsp;&nbsp;<a class="dataAdd" href="###" style="color:green;font-size:14px;">增加一行<span style="color:red;font-size:14px;">（仅支持上传jpg和png格式的图片）</span></a></legend>
		<table border="0" width="97%" class="edit_table" align="center" style="table-layout:fixed;margin:15px auto;">
			<thead>
				<tr align="center" style="background-color:#E4F0FC;">
					<th width="5%" style="font-size:17px;">序号</th>
					<th width="50%" style="font-size:17px;">外围参考电路图</th>
					<th width="40%" style="font-size:17px;">图片说明</th>
					<th width="5%" style="font-size:17px;">操作</th>
				</tr>
			</thead>
			<tbody class="tbody">
				<tr class="modelTr" style="display:none;" align="center">
					...
					<td style="word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
						<input type="hidden" name="designFileListD[#index].type" value="外围参考电路图" />
						<input type="file" name="fileD" accept="image/jpeg,image/png" />
					</td>
					<td>
						<input type="text" class="explain" name="designFileListD[#index].explain" style="width:97%;background-color:#F0F0F0;text-align:center;" />
				...
				<s:iterator value="wuyProd.designFileSet" status="st">
					<s:if test="type=='外围参考电路图'">
						<tr class="modifyFileTr" align="center">
							...
							<td>
								<input type="text" class="explain" name="designFileVoList[#index].explain" value="<s:property value='explain' />" style="width:97%;background-color:#F0F0F0;text-align:center;" />
							</td>
							<td align="center"><a class="delBtn" href="javascript:;" style="color:red;">删除</a></td>
						</tr>
					</s:if>
