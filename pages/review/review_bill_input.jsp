...
<div class="pageContent">
	<form action="../review/reviewAppr!handleReviewFeedback.action" enctype="multipart/form-data" method="post" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);" >	
			...
			<fieldset>
				...
				<table width="98%" class="edit_table" align="center">
					<tr>
						...
						<td colspan="2"><input name="reviewProduct.auditorId" type="hidden" class="required" value="<s:property value='reviewBill.tableManager.id'/>"> 
							<input name="reviewProduct.auditorName" type="text" class="required" onclick="$(this).next().click()" readonly="readonly" value="<s:property value='reviewBill.tableManager.name'/>"> 
