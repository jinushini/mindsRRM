...
<div class="pageContent">
  <form method="post" enctype="multipart/form-data" action="../review/Product_importExcel_zhengji-order-list.action" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
	<div class="pageFormContent" layoutH="56">
		<br/>
	<fieldset>
		<legend>复查产品导入</legend>
