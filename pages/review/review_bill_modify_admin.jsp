...
<div class="pageContent">
	<form action="../review/review!modifyReviewRequest.action" enctype="multipart/form-data" method="post" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);" >	
		...
		<div class="pageFormContent" layoutH="56"><br/>
			<fieldset>
				...
				<table width="98%" class="edit_table" align="center">
					...
					<td width="30%"><s:date name="reviewBill.limdat" format="yyyy-MM-dd"/></td>
					</tr>
						<tr>
