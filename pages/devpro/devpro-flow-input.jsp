...
<div class="pageContent">
  <form id="formdata" method="post" enctype="multipart/form-data" action='../devpro/DevProAppr_saveAndSartProject.action' class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
	<input type="hidden" id="id" name="id" value='<s:property value="devPro.id"/>'/>
	<input type="hidden" id="processInstId" name="processInstId" value='<s:property value="devPro.flowRun.processInstId"/>'/>
	...
	<div class="pageFormContent" layoutH="56">
		...
		<fieldset>
			...
			<legend>配置参数--<s:property value="devPro.flowRun.flowName"/></legend>
			<table bproduct="0" width="98%" class="edit_table fluwRunConfig" align="center">
				...
				<s:iterator value="devPro.flowRun.nodes" var="a">
					<tr class="node" level="1">
						...
						<td align="center"><input class="dates" name="flowRunNodeVoList[#index].scheduleDate.manHours" value='<s:property value="scheduleDate.manHours"/>' style="width:98%;border:0;font-size:15px;text-align:center;" ></td>
						<td align="center">
