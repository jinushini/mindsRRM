...
<div class="pageContent">
  <form method="post" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
	<div class="pageFormContent" layoutH="56">
		<br/>
		<fieldset>
			<legend>填写任务详情</legend>			
			<table border="0" width="98%" class="edit_table" align="center" id="itemList">
				<!-- <tr>
					<td><a class="btnSelect" href="" title="查找带回">选择</a></td>
				</tr> -->
				<tr>
					<td colspan="2"><textarea name="dispatch.taskDefinition" id="taskDefinition" class="editor" rows="10" style="width: 98%;" upImgUrl="../dispatch/dispatchAppr!upload.action" upImgExt="jpg,jpeg,gif,png,doc"><s:property value="dispatch.taskDefinition" escape="false" /><s:property value="taskDefinition" /></textarea></td>
				</tr>
				<!-- <tr>
