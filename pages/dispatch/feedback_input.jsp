...
<div class="pageContent">
  <form method="post" enctype="multipart/form-data" action='../dispatch/dispatchAppr!addFeedback.action' class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
	...
	<div class="pageFormContent" layoutH="56">
		...
		<fieldset>
			...
			<table border="0" width="98%" class="edit_table" align="center">
				...
				<tr>
					<td align="center" width="15%">完成形式：</td>
		...
		<fieldset <s:if test="dispatch.needApprove == 2">style="visibility:hidden;"</s:if>>
			<legend>人员选择</legend>
			<table border="0" width="98%" class="edit_table" align="center">
				<tr>
					<td align="center">审核人</td>
					<td >
						<input name="dispatch.auditor.id" type="hidden" <s:if test="dispatch.needApprove == 1">class="required"</s:if>  value="<s:property value="dispatch.auditor.id"/>"/>
						<input name="dispatch.auditor.name" value="<s:property value="dispatch.auditor.name"/>" type="text" <s:if test="dispatch.needApprove == 1">class="required"</s:if> readonly="readonly" onclick="$(this).next().click()"/>
