...
<div class="pageContent">
  <form action="../dispatch/dispatch!startOrderProcess.action" id="searchFrm" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" >
		...
		<br/>
	<fieldset>
		<legend>分派任务&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a name="addBtn" href="###" style="color : green;">增加一行</a></legend>
			<table class="list_table edit_table" width="98%" style="table-layout:fixed;" >
				...
				<tbody id="itemList">
					<tr>
						<td align="center"><input name="dispatchList[#index].taskName" value="" style="width:90%;"></td>
						<td align="center">
						...
						<td>
							...
							<input name="dispatchList[#index].taskModelNum" value="" readonly="readonly" type="hidden"/>
							<input name="dispatchList[#index].taskDefinition" style="width:90%;" type="text" readonly="readonly" value="" suggestFields="taskModelNum,taskDefinition,filesource" suggestUrl="" lookupGroup="dispatchList[#index]" lookupPk="taskModelNum" onclick="$(this).next().attr('href','../dispatch/dispatch!inputTaskModel.action?taskDefinition='+$(this).val()+'');$(this).next().click()"/>
							<a class="model" href="###" lookupGroup="dispatchList[#index]" lookupPk="taskModelNum"></a>
						</td>
						<td><input name="dispatchList[#index].scheduleDate.planEndDate" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" type="text"></td>
						<td align="center">					
							<!-- <a name="" href="###" >详情</a>| -->
