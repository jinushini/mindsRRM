...
<div class="pageContent">
  <form method="post" enctype="multipart/form-data" action='../readzkword/updloadFile!uploadFile2.action' class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
	<div class="pageFormContent" layoutH="56">
		...
		<fieldset>
			...
			<table border="0" width="98%" class="edit_table" align="center" id="itemList">
				...
				<tr>
				<td style="text-align: left;" colspan="2">产品列表(如下:)</td>
				 <td ><a name="addBtn" href="javascript:;" style="color : green;">增加产品</a></td>
				</tr>
				<tr class="file">
				     
					<td ><input type="file" name="ysfilesource"/></td>
					<td  ><a name="delBtn" href="javascript:;" style="color : red;">删除</a></td>
				</tr>
				<!-- <tr>
				<td style="text-align: left;" colspan="2">产品2(如下:)</td>
				</tr>
				<tr class="file">
				...
				<tr>
				<td style="text-align: left;" colspan="2">产品3(如下:)</td>
				</tr>
				<tr class="file">
				...
				<tr>
				<td style="text-align: left;" colspan="2">产品4(如下:)</td>
				</tr>
				<tr class="file">
				...
				<tr>
				<td style="text-align: left;" colspan="2">产品5(如下:)</td>
				</tr>
				<tr class="file">
				...
				<tr>
				<td style="text-align: left;" colspan="2">产品6(如下:)</td>
				</tr>
				<tr class="file">
				...
				<tr>
				<td style="text-align: left;" colspan="2">产品7(如下:)</td>
				</tr>
				<tr class="file">
