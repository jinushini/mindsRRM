...
$(function(){
	jn("#print").click(function(){			
		var url = "../readzkword/readzkword!dataexcel.action";
		jn("#print").attr("href", url);
	});
	jn("#print1").click(function(){			
		var url = "../readzkword/readzkword!testexcel.action";
		jn("#print1").attr("href", url);
	});
})
</script>
...
<div class="pageContent">
	...
	<input type="text" readonly="readonly"  size="60" name="item" value="<s:property value="#request.text"/>"/>	
	...
	<br/>
	    <ul>
			...
			<li><div class="button"><div class="buttonContent"><a type="button" class="" id="print">生成打印</a></div></div></li>
			<li><div class="button"><div class="buttonContent"><a type="button" class="" id="print1">打印试验过程数据汇总</a></div></div></li>
	    </ul>
</div>
