...
<div class="pageContent">
  <form method="post" enctype="multipart/form-data" action="../product/product!importExcel.action" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
