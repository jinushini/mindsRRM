...
<div class="pageContent">
  <form method="post" action="../product/productLib!modify.action" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
	...
	<div class="formBar" style="text-align： center;">
		<ul style="">
			...
			<li><a class="button" href="../product/productLib!showList.action?a=a&b=b"  target="navTab"><span>返回</span></a>
		</ul>			
	</div>
   </form>
</div>