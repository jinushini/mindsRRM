...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../product/productLibConfig!inputAdd.action?parentId=<s:property value='parentId'/>" target="navTab" rel=""><span>添加</span></a></li>
			<li><a class="edit" href="../product/productLibConfig!inputModify.action?productLibId={id}" target="navTab" rel=""><span>修改</span></a></li>
			<li><a class="delete" href="../product/productLibConfig!delete.action?productLibId={id}&parentId=<s:property value='parentId'/>" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="../product/productLib!showList.action" target="navTab" rel=""><span>返回</span></a></li> 
		</ul>
	</div>
	<div layoutH="90">
