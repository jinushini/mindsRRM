...
<div class="pageHeader">
	<form onsubmit="return dialogSearch(this);" action="../product/product!showListForDialog.action" method="post">
	<div class="searchBar">
		<ul class="searchContent" >
			...
			<li>
				模块代号：<input type="text" name="paramMap['p.moduleCode like']" value="<s:property value="paramMap['p.moduleCode like']"/>" />
			</li>
		...
		<table class="list_table list" width="500%" layoutH="120" style="table-layout:fixed;">
			<thead>
				<tr>
					...
					<th align="center" width="15%">单机主管</td>
				
					<th align="center" width="15%">开始时间</th>
					<th align="center" width="15%">计划交付时间</th>
				
					<th align="center" width="15%">模块代号</th>
					<th align="center" width="15%">模块设计师</th>
				
					<th align="center" width="20%">单台单机模块数量</th>
					<th align="center" width="15%">模块装机数量</th>
